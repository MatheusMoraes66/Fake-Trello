...
<template>
    <div class="w-full h-16 flex justify-around p-2 border-b-2 border-neutral-500">
        ...
        <div class=" flex items-center justify-center w-4/12 ">
            <UButton ui="{primary: 'black'}" @click="emitOpenModal" icon="i-heroicons-magnifying-glass-20-solid" block
